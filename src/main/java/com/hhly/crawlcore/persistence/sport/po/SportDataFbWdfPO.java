...
public class SportDataFbWdfPO{
    ...
    public SportDataFbWdfPO() {
    }

    public SportDataFbWdfPO(Long sportAgainstInfoId, Short letNum, Float spWin, Float spDraw, Float spFail, Short spType, Date releaseTime) {
    ...
    public Boolean isEquals(SportDataFbWdfPO lastPO){
    	if(spWin.equals(lastPO.getSpWin()) && spDraw.equals(lastPO.getSpDraw()) 
    			&& spFail.equals(lastPO.getSpFail()) && (letNum == null ? true : letNum.equals(lastPO.getLetNum())) 
    			&& spType.equals(lastPO.getSpType()))
    	  	return true;
    	return false;
    }    
}